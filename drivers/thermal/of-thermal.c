...
#ifdef CONFIG_GOOGLE_DRIVER_MODIFY
	int ret;
	int sensor_temp;
#endif
...
#ifdef CONFIG_GOOGLE_DRIVER_MODIFY
	ret = data->ops->get_temp(data->sensor_data, &sensor_temp);
	if (ret)
		return ret;
	*temp = tz->tzp->slope * sensor_temp + tz->tzp->offset;
	return 0;
#else
...
#ifndef CONFIG_GOOGLE_DRIVER_MODIFY
